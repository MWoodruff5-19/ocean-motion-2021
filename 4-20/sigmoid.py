...
decision = "Should I get a dinosaur bucket hat instead of a frog bucket hat?"

# Pick three factors that affect your decision and write them as strings
factor_1 = "Is the price of the dinosaur one lower?"
factor_2 = "Does one match better with my daily outfits than the other?"
factor_3 = "Am I more likely to wear one more often than the other?"
...
# etc:
weights = np.array([4, 7, 8])#your code here
...
factor_values = np.array([0.40, 0.50, 0.70])# your code here
